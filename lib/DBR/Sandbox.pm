...
sub provision{
    ...
    _load_sqlfile ( "$CONFDIR/dbr_schema_sqlite_v$version.sql", $metadb );
    ...
    _write_dbrconf( $sandbox, $dbrconf, $version );
...
sub _write_dbrconf{
    ...
    print $fh "name=dbrconf; class=master; dbfile=$sandbox/dbrconf.sqlite; type=SQLite; dbr_bootstrap=1; meta_version=$ver\n";
    close $fh;
